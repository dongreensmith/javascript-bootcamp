...
const getPuzzleFetch = () => {
  return fetch('https://puzzle.mead.io/puzzle/?wordCount=1', {}).then((response) => {
    if(response.status === 200) {
...
///////////////////////////////////////////////////////////////////
const getPuzzleSync = () => {   // Sync version of getPuzzle() only for exercise
  const request = new XMLHttpRequest();

  request.open('GET', 'https://puzzle.mead.io/slow-puzzle/?wordCount=1', false);
  request.send();
